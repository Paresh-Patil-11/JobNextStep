  ...
  return (
    <div>
      <footer
        ...
        className=" bg-slate-200 font-medium rounded-t-3xl"
      >
        <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:p-12 ">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
            <div>
              <p className="text-5xl custom-text">JobNextStep</p>
              {/* <img src={CareerHub} alt="" srcset="" /> */}
              <p className="max-w-xs mt-4 text-gray-500 text-start">
                Dream big, work hard, and never give up. Every step forward is
                progress—stay focused, stay unstoppable!!
              </p>
              ...
              <ul className="flex gap-6 mt-8 justify-center md:justify-start">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-gray-700 transition hover:opacity-80 flex items-center"
                  >
                ...
                <li>
                  <a
                    href="https://paresh-patil-11.github.io/PortfolioSite/"
                    rel="noreferrer"
                    target="_blank"
                    className="text-gray-700 transition hover:opacity-75"
                  >
          ...
          <p className="font-bold text-gray-500 text-center bg-gradient-to-r from-indigo-500 to-indigo-800 bg-clip-text text-transparent italic">
            &copy; 2025 Paresh Patil. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
